...
// Cap the visible dropdown height so it never grows above the viewport top.
...
export function FileMentionDropdown({
  ...
  return (
    <div
      ref={dropdownRef}
      className="fixed z-50 bg-white border border-gray-300 rounded-lg shadow-lg w-96 overflow-y-auto"
      style={{
