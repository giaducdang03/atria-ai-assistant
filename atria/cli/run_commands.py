"""Run subcommand handlers for Atria CLI."""
...
from atria.ui_textual.style_tokens import CYAN, ERROR, SUCCESS, WARNING
        ...
        try:
            ...
            with console.status(f"[{CYAN}]Starting Web UI…[/{CYAN}]", spinner="dots"):
                ...
                session_manager = PgSessionManager(
                    sessionmaker=_sm, working_directory=str(working_dir)
                )
                ...
                from atria.web import find_static_directory
                ...
                try:
                    from atria.web import start_server
