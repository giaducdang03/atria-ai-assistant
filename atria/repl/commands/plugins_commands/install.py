...
from atria.repl.commands.base import CommandResult
from atria.core.plugins import (
    PluginManagerError,
    MarketplaceNotFoundError,
    PluginNotFoundError,
    BundleNotFoundError,
)
from atria.ui_textual.components.plugin_panels import create_scope_selection_panel
