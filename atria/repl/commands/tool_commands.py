...
class ToolCommands(CommandHandler):
    ...
    def init_codebase(self, command: str) -> None:
        ...
        try:
            ...
            # Check if ATRIA.md was created
            atria_path = target_path / "ATRIA.md"

            # Display final message if task succeeded
            if result.get("success") and atria_path.exists() and self.ui_callback:
                ...
                if final_content:
                    ...
                    signal = get_reminder("init_complete_signal", path=str(atria_path))
            ...
            if not self.ui_callback:
                ...
                self.print_command_header("init")
                if result.get("success") and atria_path.exists():
                    self.print_success(f"Generated ATRIA.md at {atria_path}")
