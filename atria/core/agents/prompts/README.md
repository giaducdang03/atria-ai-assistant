# Atria Prompt Architecture

This directory contains the modular prompt system for Atria agents. The architecture is inspired by Claude Code's composable prompt design.
...
# Create composer
templates_dir = Path("atria/core/agents/prompts/templates")
...
```python
grep "MY_VAR" atria/core/agents/prompts/variables.py
```
