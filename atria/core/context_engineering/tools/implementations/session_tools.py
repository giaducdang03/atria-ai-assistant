...
class SessionTools:
    ...
    def list_sessions(
        ...
        try:
            sessions = run_sync(session_manager.list_sessions())
    ...
    def get_session_history(
        ...
        try:
            ...
            try:
                messages = run_sync(session_manager.load_transcript(session_id))
            except FileNotFoundError:
                # Try loading full session
                session = run_sync(session_manager.get_session_by_id(session_id))
