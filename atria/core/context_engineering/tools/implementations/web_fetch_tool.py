...
# Crawl4AI shares a SQLite browser-profile DB; concurrent calls from multiple
# executor threads cause "database is locked". Serialize at the process level.
    ...
    async def _fetch_url_async(
        ...
        try:
            ...
            browser_config = BrowserConfig(
                headless=True,
                verbose=False,
                user_agent="Atria/1.0 (AI Assistant Tool; Crawl4AI)",
            )
