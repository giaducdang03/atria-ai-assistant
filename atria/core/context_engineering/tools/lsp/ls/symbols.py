...
if TYPE_CHECKING:
    from atria.core.context_engineering.tools.lsp.ls.server import DocumentSymbols, LSPFileBuffer
...
class SymbolsMixin:
    ...
    def request_document_symbols(
        ...
        """
        from atria.core.context_engineering.tools.lsp.ls.server import DocumentSymbols
