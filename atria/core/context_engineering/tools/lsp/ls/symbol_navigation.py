...
from atria.core.context_engineering.tools.lsp.ls_utils import FileUtils
from atria.core.context_engineering.tools.lsp.lsp_protocol_handler import lsp_types as LSPTypes

if TYPE_CHECKING:
    from atria.core.context_engineering.tools.lsp.ls.server import LSPFileBuffer, ReferenceInSymbol
...
class SymbolNavigationMixin:
    ...
    def request_referencing_symbols(
        ...
        """
        from atria.core.context_engineering.tools.lsp.ls.server import ReferenceInSymbol
