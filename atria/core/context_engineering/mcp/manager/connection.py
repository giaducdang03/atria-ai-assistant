...
class ConnectionMixin:
    ...
    async def _connect_internal(self, server_name: str) -> bool:
        ...
        from atria.core.context_engineering.mcp.config import prepare_server_config
        from atria.core.context_engineering.mcp.manager.manager import _SuppressStderr
