...
class DockerDeployment:
    ...
    def __init__(
        ...
        self._container_name = f"atria-runtime-{uuid.uuid4().hex[:8]}"
    ...
    async def _start_container(self) -> None:
        ...
        env_vars = {
            "ATRIA_AUTH_TOKEN": self._auth_token,
            "ATRIA_PORT": str(self.config.server_port),
...
AUTH_TOKEN = os.environ.get("ATRIA_AUTH_TOKEN")
PORT = int(os.environ.get("ATRIA_PORT", "8000"))
