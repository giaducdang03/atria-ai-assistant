...
class MarketplaceMixin:
    ...
    def add_marketplace(
        ...
        """
        from atria.core.plugins.manager.manager import PluginManagerError
        ...
        if not self._validate_marketplace(target_dir):
            ...
            raise PluginManagerError(
                ...
                "Expected one of: .atria/marketplace.json, marketplace.json"
            )
    ...
    def remove_marketplace(self, name: str) -> None:
        ...
        """
        from atria.core.plugins.manager.manager import MarketplaceNotFoundError
    ...
    def sync_marketplace(self, name: str) -> None:
        ...
        """
        from atria.core.plugins.manager.manager import MarketplaceNotFoundError, PluginManagerError
    ...
    def _validate_marketplace(self, directory: Path) -> bool:
        ...
        1. .atria/marketplace.json (consistent with app)
        ...
        possible_paths = [
            directory / ".atria" / "marketplace.json",
