...
from atria.core.plugins.manager.bundle import BundleMixin
from atria.core.plugins.manager.installer import InstallerMixin
from atria.core.plugins.manager.marketplace import MarketplaceMixin
from atria.core.plugins.models import PluginMetadata
...
class PluginManager(MarketplaceMixin, InstallerMixin, BundleMixin):
    ...
    def _load_plugin_metadata(self, plugin_dir: Path) -> Optional[PluginMetadata]:
        ...
        1. .atria/plugin.json (consistent with app)
