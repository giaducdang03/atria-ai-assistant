...
from atria.core.plugins.models import DirectPlugin
...
class BundleMixin:
    ...
    def uninstall_bundle(self, name: str) -> None:
        ...
        """
        from atria.core.plugins.manager.manager import BundleNotFoundError
    ...
    def sync_bundle(self, name: str) -> None:
        ...
        """
        from atria.core.plugins.manager.manager import BundleNotFoundError, PluginManagerError
