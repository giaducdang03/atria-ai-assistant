...
from atria.ui_textual.utils import build_tool_call_text
from atria.ui_textual.utils.text_utils import truncate_tool_output, summarize_error
...
class ResponseRenderer:
    ...
    def __init__(self, app: "AtriaChatApp") -> None:
