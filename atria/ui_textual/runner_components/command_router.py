...
from atria.ui_textual.style_tokens import ERROR, PRIMARY, SUBTLE, CYAN, GREEN_BRIGHT, BLUE_BRIGHT
...
class CommandRouter:
    ...
    def _handle_mcp_connect_command(self, command: str) -> None:
        ...
        if not self._app:
            return
        from atria.ui_textual.controllers.mcp_command_controller import MCPCommandController
