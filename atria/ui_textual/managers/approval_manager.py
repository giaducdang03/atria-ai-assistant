...
from atria.core.runtime.approval.constants import (
    AutonomyLevel,
    is_safe_command,
)
...
class ChatApprovalManager:
    ...
    def __init__(self, console, chat_app=None):
        ...
        from atria.core.runtime.approval import ApprovalRulesManager, RuleAction
    ...
    def _check_auto_approval(self, operation, command):
        ...
        """
        from atria.core.runtime.approval import ApprovalResult, ApprovalChoice
        from atria.models.operation import OperationType
    ...
    def _process_approve_all_choice(self, command, edited_command, matched_rule):
        ...
        """
        from atria.core.runtime.approval import ApprovalResult, ApprovalChoice
        from atria.core.runtime.approval.rules import ApprovalRule, RuleType, RuleAction
