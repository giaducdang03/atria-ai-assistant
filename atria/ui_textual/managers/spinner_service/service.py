...
from atria.ui_textual.style_tokens import GREY, PRIMARY, GREEN_BRIGHT, ERROR
from atria.ui_textual.managers.spinner_service.models import (
    SpinnerInstance,
    SpinnerType,
    SpinnerFrame,
    SPINNER_CONFIGS,
)
from atria.ui_textual.managers.spinner_service.animation import AnimationMixin
from atria.ui_textual.managers.spinner_service.resize import ResizeMixin

if TYPE_CHECKING:
    from textual.app import App
    from textual.timer import Timer
    from atria.ui_textual.widgets.conversation_log import ConversationLog
