"""Animated welcome panel widget with Matrix rain Atria animation."""
...
class AnimatedWelcomePanel(Widget):
    ...
    def _render_rain_field(self) -> Text:
        """Render the matrix rain field with 'Atria' as negative space.
        ...
        # Define "Atria" exclusion zone (centered)
        label = "O p e n D e v"
        label_len = len(label)
        ...
        # Place "Atria" text with breathing effect
