...
BUILTIN_COMMANDS.register(SlashCommand("exit", "exit Atria"))
BUILTIN_COMMANDS.register(SlashCommand("quit", "exit Atria (alias for /exit)"))
...
# Advanced commands
BUILTIN_COMMANDS.register(SlashCommand("init", "analyze codebase and generate ATRIA.md"))
