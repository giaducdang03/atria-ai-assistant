...
from atria.ui_textual.formatters.style_formatter import StyleFormatter
from atria.ui_textual.style_tokens import GREY, PRIMARY
from atria.ui_textual.services import ToolDisplayService
from atria.models.message import ToolCall
from atria.ui_textual.ui_callback.tool_display import CallbackToolDisplayMixin
from atria.ui_textual.ui_callback.agent_display import CallbackAgentDisplayMixin
from atria.ui_textual.ui_callback.plan_approval import CallbackPlanApprovalMixin
...
class TextualUICallback(
    ...
    def __init__(self, conversation_log, chat_app=None, working_dir: Optional[Path] = None):
        ...
        Args:
            ...
            chat_app: The main chat app (AtriaChatApp instance) for controlling processing state
