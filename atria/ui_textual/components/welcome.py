"""Welcome banner and session info for Atria (Textual UI)."""
...
class WelcomeMessage:
    ...
    def generate_banner(cls) -> List[str]:
        ...
        header = cls._header_line(f"Atria {version}")
    ...
    def generate_full_welcome(
        ...
        left_entries: List[Tuple[str, str]] = [
            ...
            ("", "left"),
            (f"{CYAN}╔═══════════╗{RESET}", "center"),
            (f"{CYAN}║  {BOLD}Atria{RESET}{CYAN}  ║{RESET}", "center"),
            (f"{CYAN}╚═══════════╝{RESET}", "center"),
            ("", "left"),
        ...
        right_entries: List[Tuple[str, str]] = [
            ...
            (f" • {CYAN}/init{RESET}           Generate ATRIA.md documentation", "left"),
            ("", "left"),
        ...
        return [
            "",
            cls._header_line(f"Atria {version}"),
            *rows,
            cls._footer_line(),
        ]
