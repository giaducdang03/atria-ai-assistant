...
from atria.ui_textual.style_tokens import BLUE_BG_ACTIVE, BLUE_LIGHT, GREY
...
class ModelPickerController:
    ...
    async def _commit_single_model(self, slot: str, provider_info, model_info) -> bool:
        ...
        handler = self.app.on_session_model_selected if session_mode else self.app.on_model_selected
