"""Textual-based chat application for Atria - POC."""
...
from atria.ui_textual.widgets import AnimatedWelcomePanel, ConversationLog, ProgressBar
from atria.ui_textual.widgets.chat_text_area import ChatTextArea
from atria.ui_textual.widgets.status_bar import StatusBar
from atria.ui_textual.widgets.debug_panel import DebugPanel
from atria.ui_textual.widgets.todo_panel import TodoPanel
from atria.ui_textual.components import TipsManager
from atria.ui_textual.controllers.approval_prompt_controller import ApprovalPromptController
from atria.ui_textual.controllers.ask_user_prompt_controller import AskUserPromptController
from atria.ui_textual.controllers.plan_approval_controller import PlanApprovalController
from atria.ui_textual.controllers.autocomplete_popup_controller import AutocompletePopupController
from atria.ui_textual.controllers.command_router import CommandRouter
from atria.ui_textual.controllers.message_controller import MessageController
from atria.ui_textual.controllers.model_picker_controller import ModelPickerController
from atria.ui_textual.controllers.agent_creator_controller import AgentCreatorController
from atria.ui_textual.controllers.skill_creator_controller import SkillCreatorController
from atria.ui_textual.controllers.spinner_controller import SpinnerController
from atria.ui_textual.managers.console_buffer_manager import ConsoleBufferManager
from atria.ui_textual.managers.message_history import MessageHistory
from atria.ui_textual.managers.tool_summary_manager import ToolSummaryManager
from atria.ui_textual.managers.spinner_service import SpinnerService
from atria.ui_textual.managers.interrupt_manager import InterruptManager, InterruptState

# Note: render_welcome_panel no longer used - replaced by AnimatedWelcomePanel widget


class AtriaChatApp(App):
    """Atria Chat Application using Textual."""
    ...
    def on_mount(self) -> None:
        ...
        from atria.ui_textual.debug_logger import clear_debug_log, debug_log
        ...
        if self.on_message:
            self.title = "Atria Chat"
            self.sub_title = "AI-powered coding assistant"
        else:
            self.title = "Atria Chat (Textual POC)"
    ...
    def action_show_subagent_picker(self) -> None:
        ...
        if len(entries) == 1:
            ...
            from atria.ui_textual.screens.session_picker import SessionPicker
    ...
    def _open_subagent_detail(self, session_manager: Any, entry: dict) -> None:
        ...
        """
        from atria.ui_textual.screens.subagent_detail import SubagentDetailScreen
...
def create_chat_app(
    ...
    Returns:
        Configured AtriaChatApp instance
    """
    return AtriaChatApp(
