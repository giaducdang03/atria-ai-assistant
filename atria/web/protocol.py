...
class WSMessageType(str, Enum):
    ...
    DEEP_RESEARCH_TAXONOMY_READY = "deep_research_taxonomy_ready"
    DEEP_RESEARCH_QUEUED = "deep_research_queued"
    DEEP_RESEARCH_START = "deep_research_start"
    DEEP_RESEARCH_SECTION_START = "deep_research_section_start"
    DEEP_RESEARCH_SECTION_DONE = "deep_research_section_done"
    ...
    DEEP_RESEARCH_TAXONOMY_RESPONSE = "deep_research_taxonomy_response"
    PING = "ping"
    INTERRUPT = "interrupt"
