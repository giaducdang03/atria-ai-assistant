"""Tests for AtriaChatApp.call_from_thread override and call_from_thread_nonblocking."""
...
def _make_app() -> AtriaChatApp:
    """Create a minimal AtriaChatApp for testing (no Textual runtime)."""
    app = AtriaChatApp.__new__(AtriaChatApp)
    app._loop = MagicMock()
...
class TestCallFromThreadOverride:
    """Tests for the call_from_thread override on AtriaChatApp."""
...
class TestCallFromThreadNonblocking:
    """Tests for call_from_thread_nonblocking on AtriaChatApp."""
