...
from atria.core.agents.components.api.http_client import (
    MAX_RETRIES,
    AgentHttpClient,
    HttpResult,
)
...
class TestHttpClientRetry:
    ...
    def test_retry_on_429(self, client: AgentHttpClient) -> None:
        ...
        with (
            ...
            patch(
                "atria.core.agents.components.api.http_client.time.monotonic",
                side_effect=fast_monotonic,
            ),
            patch("atria.core.agents.components.api.http_client.time.sleep"),
        ):
