...
from atria.core.agents.components.api.openai_responses_adapter import OpenAIResponsesAdapter
...
class TestResolveVlmModelAndClient:
    ...
    def test_vlm_different_provider_fallback_on_none(self):
        ...
        with patch(
            "atria.core.agents.main_agent.http_clients.create_http_client_for_provider",
