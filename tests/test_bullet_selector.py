...
from atria.core.context_engineering.memory.playbook import Bullet, Playbook
from atria.core.context_engineering.memory.selector import BulletSelector, ScoredBullet
...
class TestSemanticSimilarity:
    ...
    def test_embedding_cache_file_persistence(self, tmp_path):
        ...
        # Load from file
        from atria.core.context_engineering.memory.embeddings import EmbeddingCache
