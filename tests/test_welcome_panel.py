...
from atria.ui_textual.widgets.welcome_panel import (
    AnimatedWelcomePanel,
    hsl_to_ansi256,
)
from atria.core.runtime import OperationMode
...
class TestWelcomePanelSessionResumption:
    ...
    def test_chat_app_new_session_defaults(self):
        ...
        app = AtriaChatApp(is_resumed_session=False)
    ...
    def test_chat_app_resumed_session_flags(self):
        ...
        app = AtriaChatApp(is_resumed_session=True)
...
class TestAnimatedWelcomePanelIntegration:
    ...
    def test_import_from_widgets(self):
        ...
        from atria.ui_textual.widgets import AnimatedWelcomePanel as Imported
