...
from atria.core.hooks.models import (
    HookEvent,
    HookCommand,
    HookMatcher,
    HookConfig,
...
from atria.core.hooks.executor import HookResult, HookCommandExecutor
from atria.core.hooks.manager import HookManager
from atria.core.hooks.loader import load_hooks_config, _read_hooks_from_file
...
class TestLoader:
    ...
    def test_load_hooks_config_merges(self, tmp_path):
        ...
        global_dir = tmp_path / "global" / ".atria"
        ...
        project_dir.mkdir()
        project_atria = project_dir / ".atria"
        project_atria.mkdir()
        project_settings = project_atria / "settings.json"
        ...
        with patch("atria.core.paths.get_paths") as mock_paths:
            mock_p = MagicMock()
