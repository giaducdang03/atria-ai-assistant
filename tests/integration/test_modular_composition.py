...
def test_modular_composition_loads_all_sections():
    ...
    templates_dir = Path(__file__).parent.parent.parent / "atria/core/agents/prompts/templates"
...
def test_system_prompt_builder_uses_modular():
    ...
    from atria.core.agents.components.prompts.environment import EnvironmentContext
    from pathlib import Path
...
def test_modular_files_have_frontmatter():
    ...
    templates_dir = (
        Path(__file__).parent.parent.parent / "atria/core/agents/prompts/templates/system/main"
    )
...
def test_thinking_modular_files_have_frontmatter():
    ...
    templates_dir = (
        Path(__file__).parent.parent.parent / "atria/core/agents/prompts/templates/system/thinking"
    )
...
def test_thinking_composition_loads_sections():
    ...
    from atria.core.agents.prompts.composition import create_thinking_composer
