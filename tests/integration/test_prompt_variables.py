...
def test_variable_substitution_in_real_template():
    ...
    from atria.core.agents.prompts.renderer import PromptRenderer
    ...
    template_path = (
        ...
        / "atria/core/agents/prompts/templates/reminders/reminder-plan-mode-active.md"
    )
...
def test_all_tool_variables_resolve():
    ...
    from atria.core.agents.prompts.variables import PromptVariables
